 ...
 */
abstract class PreviewCategory extends \Magento\Backend\App\Action
{
    /**
     * Core registry
     *
    ...
    protected function _initAction()
    {
        ...
        $resultPage->setActiveMenu('Magenest_SuperEasySeo::preview_category')
            ->addBreadcrumb(__('Preview Categpry'), __('Preview Categpry'));
        $resultPage->getConfig()->getTitle()->set(__('Preview Categpry'));
    ...
    {
        return $this->_authorization->isAllowed('Magenest_SuperEasySeo::preview_category');
    }
}
