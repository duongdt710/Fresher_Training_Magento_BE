...
class PhtmlTemplateTest extends \PHPUnit\Framework\TestCase
{
    public function testBlockVariableInsteadOfThis()
    {
        ...
        $invoker(
            /**
             * Test usage of methods and variables in templates through $this
             *
             * @param string $file
             */
            function ($file) {
    ...
    public function testObsoleteBlockMethods()
    {
        ...
        $invoker(
            /**
             * Test usage of protected and private methods and variables in templates
             *
             ...
             * since introduction of multiple templates engines support
             *
             * @param string $file
             */
            function ($file) {
