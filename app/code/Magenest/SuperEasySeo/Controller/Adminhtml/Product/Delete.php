    ...
    public function execute()
    {
        ...
        if ($templateId) {
            ...
            try {
                ...
                return $resultRedirect->setPath('seo/product/index', ['_current'=>true]);
                ...
                $this->_redirect('seo/product/edit', ['id' => $templateId, '_current' => true]);
                return $resultRedirect->setPath('seo/product/edit', ['id' => $templateId, '_current' => true]);
            }
        }
